...
Now that we are familiar with what a CloudEvent is, what a CloudEvent message looks like, the different Event Formats available, lets see how we can create one programmatically.
